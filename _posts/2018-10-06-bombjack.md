...
between 1 and 4 to the address 0x9E00 (value 0 seems to be special and renders
...
- **00**: 1st sound-chip: select register
- **01**: 1st sound-chip: access selected register 
- **02**: 2nd sound-chip: select register
- **03**: 2nd sound-chip: access selected register 
- **04**: 3rd sound-chip: select register
- **05**: 3rd sound-chip: access selected register 

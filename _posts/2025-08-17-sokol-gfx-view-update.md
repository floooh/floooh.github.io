...
- **mrt-sapp** (multiple-render-target, multi-sampled offscreen rendering): [C code](https://github.com/floooh/sokol-samples/blob/master/sapp/mrt-sapp.c), [GLSL code](https://github.com/floooh/sokol-samples/blob/master/sapp/mrt-sapp.glsl), [WebGPU sample](https://floooh.github.io/sokol-webgpu/mrt-sapp-ui.html)
